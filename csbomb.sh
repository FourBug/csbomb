#!/bin/bash
clear
echo -e "\e[4;31m FourBug Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m CSBomb \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.FourBug ]];then
...
echo This Script Was Made By FourBug >update.FourBug
...
echo -e "\e[4;34m This Bomber Was Created By FourBug \e[0m"
